...
{
    public partial class HardDifficultyForm : Form
...

    {
        ...
        public static HardDifficultyForm hardDifficultyFormInstance;
        public Label lbl;
        public Label lblTime;

        PictureBox MakenMaraca = new PictureBox();        

        public HardDifficultyForm()
        {
            InitializeComponent();
            hardDifficultyFormInstance = this;
        ...
        private void moveTimerEvent(object sender, EventArgs e)
        {
            ...
            if ((the_moving_snake.Bounds.IntersectsWith(cactus1.Bounds) ||
                the_moving_snake.Bounds.IntersectsWith(cactus2.Bounds) ||
                the_moving_snake.Bounds.IntersectsWith(cactus3.Bounds) ||
                the_moving_snake.Bounds.IntersectsWith(cactus4.Bounds) ||
                the_moving_snake.Bounds.IntersectsWith(cactus5.Bounds)) && GAMEOVER == false)
            {
                GAMEOVER = true;
                timer2.Stop();
                this.Hide();
        ...
        private void MakePicterBox()
        {
            ...
            new_pic.Height = 30;
            new_pic.Width = 30;
            listForD.Images.Add(Image.FromFile(Application.StartupPath + "\\ImagesFiles\\Hard Diffilculty Form\\dorito.jpg"));            
            new_pic.BackgroundImage = listForD.Images[0];
            listForD.Images.Clear();

            x = rand.Next(223, this.ClientSize.Width - new_pic.Width - 472); 
            y = rand.Next(35, this.ClientSize.Height - new_pic.Height - 66);

            
            new_pic.Location = new Point(x,y);
            new_pic.BackgroundImageLayout = ImageLayout.Zoom;
            
            while (new_pic.Bounds.IntersectsWith(cactus1.Bounds) ||
                new_pic.Bounds.IntersectsWith(cactus2.Bounds) ||
                new_pic.Bounds.IntersectsWith(cactus3.Bounds) ||
                new_pic.Bounds.IntersectsWith(cactus4.Bounds) ||
                new_pic.Bounds.IntersectsWith(cactus5.Bounds) ||
                new_pic.Bounds.IntersectsWith(the_moving_snake.Bounds))
            {
                x = rand.Next(223, this.ClientSize.Width - new_pic.Width - 472);
                y = rand.Next(35, this.ClientSize.Height - new_pic.Height - 66);
        ...
        private PictureBox MakeMaraca()
        {
            ...
            new_pic2.Height = 30;
            new_pic2.Width = 30;
            listForM.Images.Add(Image.FromFile(Application.StartupPath + "\\ImagesFiles\\Hard Diffilculty Form\\SigleMaracas.jpg"));
        ...
        private void cactus2_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, cactus2.ClientRectangle, Color.Red, ButtonBorderStyle.Solid);
        }

        private void cactus1_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, cactus1.ClientRectangle, Color.Red, ButtonBorderStyle.Solid);
        }

        private void cactus3_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, cactus3.ClientRectangle, Color.Red, ButtonBorderStyle.Solid);
        }

        private void cactus4_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, cactus4.ClientRectangle, Color.Red, ButtonBorderStyle.Solid);
        }

        private void cactus5_Paint(object sender, PaintEventArgs e)
        {
            ControlPaint.DrawBorder(e.Graphics, cactus5.ClientRectangle, Color.Red, ButtonBorderStyle.Solid);
        }
